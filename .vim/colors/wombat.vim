...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>dotfiles/.vim/colors/wombat.vim at master · jweslley/dotfiles</title>
...
<meta content="Lsw48Y2cBa+4ZE6gicn8xvLQu/jAHvzkFo23dOdtV38=" name="csrf-token" />
    ...
    <script defer="defer" src="https://a248.e.akamai.net/assets.github.com/javascripts/bundles/github-ed88cce616e7fb55dea93e5ffadc963054853f83.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/jweslley/dotfiles/blob/8a1dc27f21d2269cb8a911608a66a08744e262d9/.vim/colors/wombat.vim'>
    <meta property="og:title" content="dotfiles"/>
    <meta property="og:type" content="githubog:gitrepository"/>
    <meta property="og:url" content="https://github.com/jweslley/dotfiles"/>
    ...
    <meta property="og:description" content="dotfiles - Jonhnny Weslley's configuration shiznit that makes him productive."/>

    <meta name="description" content="dotfiles - Jonhnny Weslley's configuration shiznit that makes him productive." />
  <link href="https://github.com/jweslley/dotfiles/commits/master.atom" rel="alternate" title="Recent Commits to dotfiles:master" type="application/atom+xml" />
...
<form accept-charset="UTF-8" action="/search" id="top_search_form" method="get"><input name="utf8" type="hidden" value="&#x2713;" />        <a href="/search" class="advanced-search tooltipped downwards" title="Advanced Search"><span class="mini-icon advanced-search"></span></a>
  ...
  <div id="userbox">
    <div id="user">
      <a href="https://github.com/constantinoneto"><img height="20" src="https://secure.gravatar.com/avatar/48fba128061c6f519aa63deaf7e8ff4e?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-140.png" width="20" /></a>
      <a href="https://github.com/constantinoneto" class="name">constantinoneto</a>
    </div>
    <ul id="user-links">
      <li>
      ...
      <div class="container hentry">
        ...
        <div class="title-actions-bar">
          ...
          <li class="js-toggler-container watch-button-container ">
            <a href="/jweslley/dotfiles/toggle_watch" class="minibutton btn-watch watch-button js-toggler-target" data-method="post" data-remote="true" rel="nofollow"><span><span class="icon"></span>Watch</span></a>
            <a href="/jweslley/dotfiles/toggle_watch" class="minibutton btn-watch unwatch-button js-toggler-target" data-method="post" data-remote="true" rel="nofollow"><span><span class="icon"></span>Unwatch</span></a>
          </li>

              <li><a href="/jweslley/dotfiles/fork" class="minibutton btn-fork fork-button" data-method="post" rel="nofollow"><span><span class="icon"></span>Fork</span></a></li>
      ...
      <li class="repostats">
        <ul class="repo-stats">
          <li class="watchers ">
            <a href="/jweslley/dotfiles/watchers" title="Watchers" class="tooltipped downwards">
              6
            </a>
          </li>
          <li class="forks">
            <a href="/jweslley/dotfiles/network" title="Forks" class="tooltipped downwards">
              1
            </a>
          </li>
        </ul>
...
<a href="/jweslley" class="url fn" itemprop="url" rel="author">              <span itemprop="title">jweslley</span>
              </a></span> /
            <strong><a href="/jweslley/dotfiles" class="js-current-repository">dotfiles</a></strong>
          </h1>
        </div>
  ...
  <ul class="tabs">
    <li><a href="/jweslley/dotfiles" class="selected" highlight="repo_sourcerepo_downloadsrepo_commitsrepo_tagsrepo_branches">Code</a></li>
    <li><a href="/jweslley/dotfiles/network" highlight="repo_network">Network</a>
    <li><a href="/jweslley/dotfiles/pulls" highlight="repo_pulls">Pull Requests <span class='counter'>0</span></a></li>


      <li><a href="/jweslley/dotfiles/wiki" highlight="repo_wiki">Wiki <span class='counter'>7</span></a></li>

    <li><a href="/jweslley/dotfiles/graphs" highlight="repo_graphsrepo_contributors">Graphs</a></li>

  </ul>
 
<div class="frame frame-center tree-finder" style="display:none"
      data-tree-list-url="/jweslley/dotfiles/tree-list/8a1dc27f21d2269cb8a911608a66a08744e262d9"
      data-blob-url-prefix="/jweslley/dotfiles/blob/8a1dc27f21d2269cb8a911608a66a08744e262d9"
    >

  <div class="breadcrumb">
    <span class="bold"><a href="/jweslley/dotfiles">dotfiles</a></span> /
    <input class="tree-finder-input js-navigation-enable" type="text" name="query" autocomplete="off" spellcheck="false">
  </div>

    <div class="octotip">
      <p>
        <a href="/jweslley/dotfiles/dismiss-tree-finder-help" class="dismiss js-dismiss-tree-list-help" title="Hide this notice forever" rel="nofollow">Dismiss</a>
...
<div class="subnav-bar">
  ...
  <ul class="actions subnav">
    <li><a href="/jweslley/dotfiles/tags" class="blank" highlight="repo_tags">Tags <span class="counter">0</span></a></li>
    <li><a href="/jweslley/dotfiles/downloads" class="blank downloads-blank" highlight="repo_downloads">Downloads <span class="counter">0</span></a></li>
          ...
          <div class="context-body pane-selector commitish-selector js-filterable-commitishes">
            <div class="filterbar">
              ...
              <div class="commitish-item branch-commitish selector-item">
                <h4>
                    <a href="/jweslley/dotfiles/blob/master/.vim/colors/wombat.vim" data-name="master" rel="nofollow">master</a>
                </h4>
              </div>
  ...
  <ul class="subnav with-scope">
    ...
    <li><a href="/jweslley/dotfiles" class="selected" highlight="repo_source">Files</a></li>
    <li><a href="/jweslley/dotfiles/commits/master" highlight="repo_commits">Commits</a></li>
    <li><a href="/jweslley/dotfiles/branches" class="" highlight="repo_branches" rel="nofollow">Branches <span class="counter">1</span></a></li>
  </ul>
...
<!-- block_view_fragment_key: views7/v8/blob:v21:1bda1b02558e0d0dc72538bd13937686 -->
  <div id="slider">

    <div class="breadcrumb" data-path=".vim/colors/wombat.vim/">
      <b itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/jweslley/dotfiles/tree/c88faf0af0790558efee8ed3a3eded0613d9ef7d" class="js-rewrite-sha" itemprop="url"><span itemprop="title">dotfiles</span></a></b> / <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/jweslley/dotfiles/tree/c88faf0af0790558efee8ed3a3eded0613d9ef7d/.vim" class="js-rewrite-sha" itemscope="url"><span itemprop="title">.vim</span></a></span> / <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/jweslley/dotfiles/tree/c88faf0af0790558efee8ed3a3eded0613d9ef7d/.vim/colors" class="js-rewrite-sha" itemscope="url"><span itemprop="title">colors</span></a></span> / <strong class="final-path">wombat.vim</strong> <span class="js-clippy mini-icon clippy " data-clipboard-text=".vim/colors/wombat.vim" data-copied-hint="copied!" data-copy-hint="copy to clipboard"></span>
    </div>


      <div class="commit file-history-tease" data-path=".vim/colors/wombat.vim/">
        <img class="main-avatar" height="24" src="https://secure.gravatar.com/avatar/1b70347c9182934213b3262851b60fc1?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-140.png" width="24" />
        <span class="author"><a href="/jweslley">jweslley</a></span>
        <time class="js-relative-date" datetime="2011-02-02T03:51:57-08:00" title="2011-02-02 03:51:57">February 02, 2011</time>
        <div class="commit-title">
            <a href="/jweslley/dotfiles/commit/570b08da02f1eecf2d589a630f980e2b57c17d69" class="message">vim color scheme: wombat</a>
        </div>
        ...
        <div id="blob_contributors_box" style="display:none">
          ...
          <ul class="facebox-user-list">
            <li>
              <img height="24" src="https://secure.gravatar.com/avatar/1b70347c9182934213b3262851b60fc1?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-140.png" width="24" />
              <a href="/jweslley">jweslley</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path=".vim/colors/wombat.vim/" data-permalink-url="/jweslley/dotfiles/blob/c88faf0af0790558efee8ed3a3eded0613d9ef7d/.vim/colors/wombat.vim" data-title="dotfiles/.vim/colors/wombat.vim at master · jweslley/dotfiles · GitHub" data-type="blob">
          ...
          <div class="file">
            <div class="meta">
              ...
              <ul class="button-group actions">
                  <li>
                    <a class="grouped-button file-edit-link minibutton bigger lighter js-rewrite-sha" href="/jweslley/dotfiles/edit/c88faf0af0790558efee8ed3a3eded0613d9ef7d/.vim/colors/wombat.vim" data-method="post" rel="nofollow"><span>Edit this file</span></a>
                  </li>

                <li>
                  <a href="/jweslley/dotfiles/raw/master/.vim/colors/wombat.vim" class="minibutton btn-raw grouped-button bigger lighter" id="raw-url"><span><span class="icon"></span>Raw</span></a>
                </li>
                  <li>
                    <a href="/jweslley/dotfiles/blame/master/.vim/colors/wombat.vim" class="minibutton btn-blame grouped-button bigger lighter"><span><span class="icon"></span>Blame</span></a>
                  </li>
                <li>
                  <a href="/jweslley/dotfiles/commits/master/.vim/colors/wombat.vim" class="minibutton btn-history grouped-button bigger lighter" rel="nofollow"><span><span class="icon"></span>History</span></a>
                </li>
              </ul>
            </div>
...
<div class="frame frame-loading large-loading-area" style="display:none;" data-tree-list-url="/jweslley/dotfiles/tree-list/8a1dc27f21d2269cb8a911608a66a08744e262d9" data-blob-url-prefix="/jweslley/dotfiles/blob/8a1dc27f21d2269cb8a911608a66a08744e262d9">
...
<div class="lower_footer">
  <div class="container clearfix">
    ...
    <![if !IE]><div id="legal"><![endif]>
      ...
      <p>&copy; 2012 <span title="0.10517s from fe5.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <span id='server_response_time' data-time='0.10776' data-host='fe5'></span>
  </body>
</html>
